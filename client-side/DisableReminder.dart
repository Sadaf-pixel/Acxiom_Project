...
import 'disable_reminder_model.dart';
export 'disable_reminder_model.dart';

class DisableReminderWidget extends StatefulWidget {
  const DisableReminderWidget({Key? key}) : super(key: key);

  @override
  _DisableReminderWidgetState createState() => _DisableReminderWidgetState();
}

class _DisableReminderWidgetState extends State<DisableReminderWidget> {
  late DisableReminderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DisableReminderModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: ['Option 1', '1', '2'],
                                    optionLabels: ['Task1', 'Task2', 'Task3'],
